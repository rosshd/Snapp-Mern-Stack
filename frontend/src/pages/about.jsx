...
const aboutUs = () => {
  return (
    ...
    w-screen bg-zinc-200 dark:bg-zinc-900 justify-center items-center py-8'>
      <div className='flex-col w-screen items-center justify-center py-12'>
        ...
        <NavBar/>
        <div className='mx-[15%] mb-[10vh] border-yellow-400 flex flex-col items-center justify-center border-y-2 rounded-md p-8 dark:bg-zinc-900 bg-zinc-400 bg-opacity-80'>
          <div>
