...
const aboutUs = () => {
  return (
    ...
    w-screen bg-zinc-200 dark:bg-zinc-900 justify-center items-center py-8'>
      <div className='h-[60%] w-screen flex flex-col lg:flex-row items-center justify-center gap-8 mb-[18%]'>
        <h1 className='text-8xl dark:text-white opacity-90 dark:bg-none rounded-md mr-8 self-end border-yellow-400 border-b-4 drop-shadow-md'>About Us</h1>
        <img src={Printer} alt="3d Printer" className='w-[300px] h-[200px] xl:h-[417px] xl:w-[500px] rounded-md  self-end shadow-md shadow-zinc-600 z-10'/>
      </div>
      <NavBar/>
