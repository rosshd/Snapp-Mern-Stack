...
const ServicePage = () => {
  ...
  return (
    <div className='overflow-y-auto bg-zinc-100 dark:bg-zinc-800 justify-center items-center'>
      <Navbar />
      <h1 className='text-center text-9xl max-md:text-7xl max-md:mt-12 text-black rounded-2xl md:mb-[15vh] max-md:mb-12 mt-[7vh] dark:text-white font-display font-bold'>Gallery</h1>
      {loading ? (
