...
const projectLanding = () => {
  return (
    <div className=' flex flex-col max-md:flex-col-reverse pt-[10vh] dark:rounded-none dark:bg-zinc-900 bg-zinc-50  rounded-2xl dark:border-none md:border-y-8 border-orange-300 md:bg-zinc-900 justify-center items-center overflow-hidden '>
