...
const projectLanding = () => {
  return (
    <div className='flex flex-col items-center justify-center bg-zinc-300'>
      <div className=' flex flex-col w-[66dvw] dark:w-screen max-md:w-screen max-md:bg-transparent max-xl:py-[5vh] dark:rounded-none dark:bg-zinc-900  rounded-2xl dark:border-none md:border-x-8 border-orange-300 bg-zinc-900 justify-center items-center overflow-hidden '>

        <ImageCycle className="flex flex-row w-[100%] h-[300px] xl:h-[50vh] max-md:h-[30vh] mb-12 z-30 overflow-hidden justify-center relative">  
        ...
        <div className='flex flex-row justify-center items-center px-12 xl:h-[30vh] h-[40vh] max-md:h-[25vh] max-md:mt-6'>
          <div className='h-fit flex flex-col gap-4 justify-center items-center max-md:self-start'>
            <h1 className='dark:text-white opacity-80 w-[50dvw] max-md:w-[80dvw] text-center drop-shadow-lg rounded-lg p-4 border-2 border-zinc-800 dark:border-gray-400'>
