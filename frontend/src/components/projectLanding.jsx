  ...
  return (
    <div className="flex flex-col items-center mb-[5vh] justify-center bg-gradient-to-b from-zinc-100 to-zinc-300 dark:to-zinc-900 dark:from-zinc-900">
      <div className="flex flex-col items-center max-md:w-[95dvw] dark:w-full w-[66dvw] md:pb-[3vh] rounded-2xl dark:bg-inherit dark:border-none md:border-x-8 border-amber-400 md:bg-zinc-900 overflow-hidden">
        ...
        <div className="flex flex-col items-center md:px-12 px-2 dark:md:w-[66dvw] max-md:mt-6 max-md:w-full">
          <h1 className="text-center text-lg md:text-xl max-md:bg-transparent dark:bg-none font-semibold md:text-gray-200 text-zinc-900 dark:opacity-80 border-2 border-zinc-400 dark:border-gray-400 p-2 rounded-lg shadow-lg md:max-w-[80dvw] max-md:w-[100%] max-md:dark:text-gray-100">
