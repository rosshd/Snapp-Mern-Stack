...
const Heading = () => {
  return (
    <div className="flex flex-col md:flex-row w-full items-center justify-center max-md:gap-10 bg-gradient-to-b from-white to-zinc-100 dark:from-zinc-800 dark:to-zinc-900 h-[95vh] max-md:py-8">
