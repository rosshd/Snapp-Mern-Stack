    ...
    <div className= 'flex flex-col justify-center max-md:justify-start items-center bg-gradient-to-b to-zinc-300 from-zinc-50 transition-colors dark:from-zinc-800 dark:to-zinc-900 h-[95vh] overflow-hidden'>
        ...
        <div className='flex max-md:flex-col justify-center items-center flex-row max-md:h-full
          w-screen p-4 lg:flex-row max-md:py-20 xl:gap-40'>
            ...
            <div className=' justify-center items-center max-w-[40dvw] max-md:max-w-[80dvw] flex xl:max-w-[600px] flex-col md:px-8 md:mr-8 max-lg:content-between max-md:my-4 rounded-xl drop-shadow-lg'>
                <picture>
                    <img src={mainLogo} className='lg:max-h-[80-px] lg:max-w-[400px] max-lg:max-w-[250px] scale-125 xl:mb-8 xl:max-h-[120px] xl:max-w-[600px] self-center dark:bg-transparent rounded-xl' alt="Snapp Labs"></img>
                </picture>
                <h1 className='overflow-hidden md:max-w-[400px] lg:max-w-[500px] xl:max-w-[600px] max-md:max-w-[250px] text-end text-lg dark:opacity-55 mb-8 font-semibold dark:text-white 
