...
const uses
 = () => {
  return (
    <div className='grid-cols-4 grid gap-[5dvw] py-[10vh]'>
      <div className='bg-slate-700 bg-opacity-50 h-[40vh] w-[18dvw] rounded-md px-2 py-2 flex flex-col justify-stretch items-center shadow-md shadow-zinc-500 hover:shadow-zinc-100 hover:rounded-xl hover:scale-105 hover:bg-zinc-800 transition duration-200'>
